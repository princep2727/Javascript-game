...
function drawEverything(){
    ...
    if(showingWinScreen){
        ...
        if(player1Score>= WINNER_SCORE){
            ...
            canvasContext.fillText("Computer Won!",(canvas.width/2)-50,canvas.height/2)
        }
        canvasContext.fillText("click to continue",(canvas.width/2)-50,800);
        return;
    }
    ...
    canvasContext.fillText(player1Score, 90,100);
